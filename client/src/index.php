...
include("app/modules/head/head_index.html"); ?>		 
<style type="text/css">
	...
	<div style="margin-right:1em; margin-left:2em;">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12">
				<div class="lft_hd" >
					<a href="index.php" ><img src="../public/assets/images/heli.png"  /></a>
				</div>
			</div>			
					...
					<div class="main_menu">
						...
						<div id="navbar">
							<ul>
                                ...
                                <li><a class="page-scroll" href="app/config/logout.php">Cerrar sesión</a></li>
								<?php }else{ ?>
...
require_once("app/config/acceso.php"); 
?>
