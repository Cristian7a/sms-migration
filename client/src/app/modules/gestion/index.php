...
<tbody>
            <tr>
                ...
                <td align="center"><a href="ver_gestion.php?IDEREP=<?php echo $iderep;?>"><IMG height="20px" SRC="../../../../public/assets/images/gestion.png"></a></td>
                <td><?php if($_SESSION["nivel"]<>2) { ?>
 <a href="javascript:openventana_var('.ventana_3',<?php echo $iderep; ?>,'IDREP','g3');"><IMG height='20px' SRC='../../../../public/assets/images/edit.png'></a>
<?php } ?>
</td>
