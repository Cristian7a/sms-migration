...
<br><a href="config/logout.php" >Cerrar sesión</a></div>
<?php if(isset($_SESSION["user1"])){ ?>

<form id="sesion" name="sesion" action="config/cambiar_sesion.php">
...
<? $fondo = isset($_SESSION['fondo']) ? $_SESSION['fondo'] : '';?>        
...
<div class="item item-blue" ><a class="post-title" href="modules/reportes"><IMG height="100px" SRC="../../public/assets/images/menu_rep.png">Reportes</a></div>
<div class="item item-teal"><a class="post-title" href="modules/gestion"><IMG height="100px" SRC="../../public/assets/images/menu_ges.png"><br>Gesti&#243;n de reportes</a></div>
<div class="item item-teal"><a class="post-title" href="modules/documentos"><IMG height="100px" SRC="../../public/assets/images/documento.png"><br>Gesti&#243;n de documentos</a></div>
<div class="item item-green2"><a class="post-title" href="modules/juntas"><IMG height="100px" SRC="../../public/assets/images/menu_inv.png"><br>Juntas de Control</a></div>
<div class="item item-red"><a class="post-title" href="modules/monitoreo"><IMG height="100px" SRC="../../public/assets/images/menu_mon.png">Monitoreo de medidas</a></div>

<div class="item item-yellow"><a class="post-title" href="tendencias"><IMG height="100px" SRC="../../public/assets/images/menu_ten.png">Tendencia</a></div>
<!--
