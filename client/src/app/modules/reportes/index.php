...
<?php } ?>
            <tr>
                ...
                <!--EDITAR -->
                <td align="center" ><a href="javascript:openventana_var('.ventana_2',<?php echo $iderep; ?>,'IDREP',1);"><IMG height="20px" SRC="../../../../public/assets/images/edit.png"></a></td>
                ...
                <td align="center" ><a href="../gestion/ver_gestion.php?IDEREP=<?php echo $iderep;?>"><IMG height="20px" SRC="../../../../public/assets//images/sin_gestion.png" title="Sin gestionar"></a></td> 
                <?php } else { ?>
                <td align="center" ><a href="../gestion/ver_gestion.php?IDEREP=<?php echo $iderep;?>"><IMG height="20px" SRC="../../../../public/assets/images/gestion.png" title="En gestión"></a></td>    
                <?php } } ?> 
            </tr>
